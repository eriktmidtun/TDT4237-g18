...
urlpatterns = [
    ...
    path("api/users/set-new-password/", views.SetNewPassword.as_view(), name="set-new-password"),
    path("api/users/password-reset/", views.ResetPasswordEmailRequest.as_view(), name="reset-password"),
